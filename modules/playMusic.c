...
Note note_table[TOTAL_NOTES] = {
    {"C", 261.63}, {"D", 293.66}, {"E", 329.63}, {"F", 349.63}, {"G", 392.00}, {"A", 440.00}, {"B", 493.88}, {"5C", 523.25}, {"5D", 587.33}, {"5E", 659.25}, {"4F#", 369.99}, {"3B", 246.94}};
...
void *play_music(void *arg)
{
    ...
    printf("[음악재생 Start...]\n");
    if (softToneCreate(BUZZER_GPIO) == -1)
    {
        printf("Error: Unable to create softTone.");
        return NULL;
    }
